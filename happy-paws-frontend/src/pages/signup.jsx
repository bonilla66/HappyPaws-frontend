                    ...
                    <div className="md:w-1/2 p-12 flex flex-col justify-center space-y-6">
                        ...
                        <form
                            ...
                            <div className="flex flex-col">
                                <label className="mb-1 text-gray-400">Nombre completo</label>
                                <input
                                    name="nombre"
                                    value={values.nombre}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col">
                                    <label className="mb-1 text-gray-400">DUI</label>
                                    <input
                                        name="dui"
                                        value={values.dui}
                                        onChange={handleChange}
                                ...
                                <div className="flex flex-col">
                                    <label className="mb-1 text-gray-400">Teléfono</label>
                                    <input
                                        name="telefono"
                            ...
                            <div className="flex flex-col">
                                <label className="mb-1 text-gray-400">Rol</label>
                                <div className="flex items-center space-x-8">
                                    <label className="inline-flex items-center space-x-2">
                                        <input
                                            ...
                                            name="rol"
                                            value="colaborador"
                                            checked={values.rol === "colaborador"}
                                            onChange={handleChange}
                                    ...
                                    <label className="inline-flex items-center space-x-2">
                                        <input
                                            ...
                                            name="rol"
                                            value="adoptante"
                                            checked={values.rol === "adoptante"}
                                            onChange={handleChange}
                                            className="h-4 w-4 accent-black cursor-pointer" />
                                        <span className="text-gray-700">Adoptante</span>
                                    </label>
                                </div>
                            </div>
